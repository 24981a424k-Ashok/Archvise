...
export default function DesignProgressStream({ steps }: DesignProgressStreamProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-md mx-auto py-20 px-4 select-none">
      {/* Animated concentric design cube */}
      <div className="relative h-28 w-28 flex items-center justify-center mb-8">
        ...
        />
        <div className="h-16 w-16 rounded-full bg-purple/20 border border-purple/30 flex items-center justify-center text-purple z-10">
      ...
      <p className="text-sm text-textSecondary text-center mb-8">
        Our system architects are designing your stack details.
      </p>
      ...
      <span className="text-[10px] text-textMuted">Designs are automatically compiled using NIM models.</span>
    </div>
  )
}
